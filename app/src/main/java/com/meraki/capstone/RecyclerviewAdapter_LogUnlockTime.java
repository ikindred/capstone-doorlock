...
public class RecyclerviewAdapter_LogUnlockTime extends RecyclerView.Adapter<RecyclerviewAdapter_LogUnlockTime.MyViewHolder> {
    ...
    public RecyclerviewAdapter_LogUnlockTime(Context context) {
        mContext = context;
